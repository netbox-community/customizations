...
class MultiConnect(Script):
    ...
    cable_type = ChoiceVar(
        choices=NO_CHOICE + CableTypeChoices.CHOICES, required=False, label="Cable Type"
    )
    ...
    cable_color = ChoiceVar(
        choices=NO_CHOICE + ColorChoices.CHOICES, required=False, label="Cable Color"
    )
    cable_length = IntegerVar(
        required=False, label="Cable Length"
    )  # unfortunately there is no DecimalVar
    cable_length_unit = ChoiceVar(
        choices=NO_CHOICE + CableLengthUnitChoices.CHOICES,
        required=False,
